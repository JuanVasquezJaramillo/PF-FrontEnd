        ...
        <>
            <div style={{ display: "flex", justifyContent: 'center' }}>
                <form style={{display: "flex", justifyContent: 'center'}} action="">
                    <input  type="search" onChange={event => handleChange(event)} value={name} className={estilo.inputSearch} placeholder="Buscar..."/>
                    <button type="submit" onClick={(event) => handleSubmit(event)} className={estilo.btnSearch}></button>
                </form>
            </div>
        </>
    )
